...
## 2. Thiết kế triển khai và phân tán

Chọn hệ quản trị cùng môi trường chạy sau khi đối chiếu yêu cầu môn học. Báo cáo hiện chưa xác định số site, tiêu chí phân mảnh, vị trí dữ liệu hoặc cơ chế sao chép.

Đầu ra cần có: lược đồ quan hệ; quyết định phân mảnh và chứng minh khả năng tái thiết; bảng phân bố dữ liệu; chính sách sao chép nếu áp dụng; cách duy trì các ràng buộc xuyên site và giao dịch liên quan tài chính.
...
## 5. Đánh giá và công bố minh chứng
